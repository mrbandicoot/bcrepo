...
base='bandicootwizard'
ADDON=xbmcaddon.Addon(id='plugin.program.bandicootwizard')
    
    
VERSION = "1.0.3"


PATH = "Bandicoot Wizard"            
...
def CATEGORIES():
    link = OPEN_URL('https://archive.org/download/Wizard_20160413_1230/Wizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("Bandicoot Wizard","Wizard is Whizzing down your Wires ",'', 'Put the kettle on')
    ...
    time.sleep(2)
    dp.update(0,"", "Extracting Your Bandicoot Build now, Please Wait")
    print '======================================='
    print addonfolder
    print '======================================='
...
def FRESHSTART(params):
    ...
    choice2 = xbmcgui.Dialog().yesno("Are you sure?", 'Are you sure you want to wipe this install?', '', 'All addons EXCLUDING Bandicoot Wizard will be completely wiped!', yeslabel='Yes',nolabel='No')
    if choice2 == 0:
        return
    elif choice2 == 1:
